  ...
  return (
    <>
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 shadow-sm">
        ...
        <p className="text-blue-800 text-sm">BuildFlow supports two execution modes for ChatGPT Actions:</p>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <p className="text-slate-600 text-xs">Import the OpenAPI schema and set Bearer token authentication. All configured sources will be searched together.</p>
          </div>
        </div>
      </div>
    </>
